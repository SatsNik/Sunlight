/**
 *Submitted for verification at testnet.bscscan.com on 2025-05-11
*/
...
contract EnergyTrading {
    ...
    mapping(address => BuyerHistory[]) public buyinghistory;
    mapping(address => Customer[]) public sellinghistory;
    mapping(address => Buyer) public buyerpage;
    mapping(address => Seller) public sellerpage;
    ...
    function buyEnergy(address sellerAddress, uint256 energyAmount) external payable {
        ...
        seller.totalenergyavailable -= energyAmount;
